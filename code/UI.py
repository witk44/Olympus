...
class UI:
    ...
    def show_exp(self,exp):
        text_surf = self.font.render("EXP: " + str(int(exp)),False,"black")
        x = self.display_surface.get_size()[0]-20
        y = self.display_surface.get_size()[1]-20
        text_rect = text_surf.get_rect(bottomright = (x,y))

        pygame.draw.rect(self.display_surface,UI_BORDER_COLOR,text_rect.inflate(10,10))
    ...
    def display(self,player):
        ...
        # self.selection_box(92,700) #magic