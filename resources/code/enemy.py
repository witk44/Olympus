...
class Enemy(Entity):
    def __init__(self, monster_name,pos,groups,obstacle_sprites,attackable_sprites,damage_player,trigger_death_particles,add_xp):
        ...
        self.death_sound = pygame.mixer.Sound(app_path('resources/audio/death.wav'))
        self.hit_sound = pygame.mixer.Sound(app_path('resources/audio/hit.wav'))
        self.attack_sound = pygame.mixer.Sound(app_path(monster_info['attack_sound']))
    ...
    def import_graphics(self,name):
        ...
        main_path = app_path(f'resources/graphics/monsters/{name}/')
