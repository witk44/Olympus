...
from resources.code.tile import Tile
from resources.code.player import Player
from resources.code.debug import debug
from resources.code.support import *
from random import choice,randint
from resources.code.weapon import Weapon
from resources.code.UI import UI
from resources.code.enemy import Enemy
from resources.code.particles import AnimationPlayer
from resources.code.magic import *
from resources.code.upgrade import Upgrade
from resources.code.death import DeathScreen
...
class Level:
    ...
    def create_map(self):
        layouts = {
            'boundary': import_csv_layout(app_path('resources/data/levels/tutorial/Tutorial._FloorBlocks.csv')),
            # 'obstacles': import_csv_layout('resources/data/levels/tutorial/Tutorial._Obstacles.csv'),
            'old_tree': import_csv_layout(app_path('resources/data/levels/tutorial/Tutorial._Tree.csv')),
            'entities': import_csv_layout(app_path('resources/data/levels/tutorial/Tutorial._Enemy.csv')),
            'player': import_csv_layout(app_path('resources/data/levels/tutorial/Tutorial._Player.csv')),
            'grass': import_csv_layout(app_path('resources/data/levels/tutorial/Tutorial._Bush.csv'))
        }
        graphics = {
            'tileset':import_folder(app_path('resources/graphics/tileset'),True),
...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.floor_surface = pygame.image.load(app_path('resources/data/levels/tutorial/Tutorial.png')).convert()
